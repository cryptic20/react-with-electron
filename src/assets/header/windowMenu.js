    ...
    return (
      ...
      <header>
        <ButtonToolbar className="menuButton">
          ...
          <Button bsStyle="warning" onClick={this.minimize_program}></Button>
          </OverlayTrigger>

          <OverlayTrigger placement="bottom" overlay={Tooltip_full_mode}>
          <Button bsStyle="success" onClick={this.eventHandler}>{this.state.toggle ? this.toggle_full_screen(false) : this.toggle_full_screen(true)}</Button>
           </OverlayTrigger>

           <OverlayTrigger placement="bottom" overlay={Quit}>
          <Button bsStyle="danger" onClick={this.close_program}></Button>
          </OverlayTrigger>
